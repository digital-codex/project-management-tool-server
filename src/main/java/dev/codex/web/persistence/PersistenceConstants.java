package dev.codex.web.persistence;
...
public class PersistenceConstants {
    ...
    public static final String VOTE_REPOSITORY_BEAN_NAME = "dev.codex.web.persistence.repository.VoteRepository";
    public static final String COMMENT_REPOSITORY_BEAN_NAME = "dev.codex.web.persistence.repository.CommentRepository";
}